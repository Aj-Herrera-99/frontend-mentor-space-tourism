...
function Member() {
    ...
    return (
        <>
            {memberCurr && (
                <div className="flex flex-col sm:flex-col-reverse xl:flex-row-reverse xl:[&>*]:w-1/2 xl:!w-full xl:grow xl:items-stretch xl:max-h-[77vh]">
                    ...
                    <div className="sm:flex-col-reverse sm:flex xl:justify-center">
                        ...
                        <section className="mt-8 mb-16 sm:mb-8">
                            <h1 className="pb-4 tracking-wide uppercase">
                                ...
                                <br />
                                <span className="block text-3xl sm:text-6xl sm:py-4">
                                    {memberCurr.name}
                                </span>
                            </h1>
